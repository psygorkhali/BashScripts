...
#               table DWH_F_POINTS_CUS_WK_A using SOURCE TABLE 
...
TARGET_TABLE="DWH_F_POINTS_CUS_WK_A"
TEMP_TABLE="TMP_F_POINTS_CUS_WK_A"
...
then
	...
	FROM ${TEMP_DB}.${TEMP_TABLE} SRC
		WHERE NOT EXISTS (
			SELECT 1
			FROM ${VIEW_DB}.V_DWH_F_POINTS_CUS_WK_A TGT
