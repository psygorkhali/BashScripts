...
######################################################################
# Script : f_points_cus_wk_history_ld.ksh
...
do
	...
	WK_CLAUSE=$(echo ${ARR_HALF_YR_SEG[1]} | tr "." " ")
	
	print_msg "HALF YEAR CLAUSE:=${HALFYR_CLAUSE}"
	print_msg "WK KEY CLAUSE:=${WK_CLAUSE}"
